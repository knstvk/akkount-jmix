...
import { normalizeEntities, normalizeEntity } from "./entityNormalizer"
...
export function getDataProvider(appConfig) {

    const restUrl = appConfig && appConfig.restUrl ? appConfig.restUrl : "/rest"
    const entitiesApi = `${restUrl}/entities`
    ...
    return {
        ...
        getOne: (resource, params) => {
            ...
            return httpClient(`${entitiesApi}/${entity}/${params.id}?${stringify(query)}`)
                .then(({json}) => ({
        ...
        getMany: (resource, params) => {
            ...
            const url = `${entitiesApi}/${entity}/search`
        ...
        getManyReference: (resource, params) => {
            ...
            const url = `${entitiesApi}/${resource}?${stringify(query)}`
        ...
        delete: (resource, params) => {
            ...
            return httpClient(`${entitiesApi}/${entity}/${params.id}`, {
                method: "DELETE",
        ...
        deleteMany: (resource, params) => {
            ...
            return httpClient(`${entitiesApi}/${entity}`, {
                method: "DELETE",
